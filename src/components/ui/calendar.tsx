  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-gray-500 text-white hover:bg-gray-600 hover:text-white focus:bg-gray-500 focus:text-white dark:bg-gray-500 dark:text-white dark:hover:bg-gray-600 dark:hover:text-white dark:focus:bg-gray-500 dark:focus:text-white",
